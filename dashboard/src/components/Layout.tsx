...
export function Layout() {
  ...
  return (
    <div className="flex h-screen flex-col bg-surface-800">
      <header className="flex shrink-0 items-center justify-between gap-4 border-b border-gray-700/50 bg-surface-900 px-4 py-3">
        <div className="flex items-center gap-4">
          <button
            type="button"
            className="md:hidden rounded p-2 text-gray-400 hover:bg-surface-700 hover:text-white"
          ...
          <h1 className="text-lg font-semibold tracking-tight text-white">Executive Command Center</h1>
          <DateDisplay />
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="relative rounded-lg border border-gray-600 bg-surface-800 p-2 text-gray-400 hover:bg-surface-700"
                ...
                <div className="absolute right-0 top-full z-20 mt-1 w-80 max-h-[70vh] overflow-auto rounded-lg border border-gray-600 bg-surface-800 py-1 shadow-xl">
                  {notifications.length === 0 ? (
                    ...
                    notifications.slice(0, 20).map((n) => (
                      <div
                        key={n.id}
                        className={`px-4 py-2 hover:bg-surface-700 ${!n.read ? "bg-blue-500/5" : ""}`}
                      >
          ...
          <div className="relative">
            <button
              type="button"
              className="flex items-center gap-2 rounded-lg border border-gray-600 bg-surface-800 px-3 py-2 text-sm text-gray-300 hover:bg-surface-700"
      ...
      <nav
        className={`shrink-0 border-b border-gray-700/50 bg-surface-900 transition-all md:block ${
              ...
              className={({ isActive }) =>
                `rounded-lg px-3 py-2 text-sm font-medium transition-colors whitespace-nowrap ${
                  isActive
                    ...
                    : "text-gray-400 hover:bg-surface-700 hover:text-gray-200 border border-transparent"
                }`
              }
            >
              {tab.label}
